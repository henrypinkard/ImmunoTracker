...
%     end % if
    ...
    uicontrol(...
        ...
        'HorizontalAlign', 'Left', ...
        'Parent', guiSortomato, ...
        'Position', [10 112+extraSpace 150 24], ...
        'String', 'Objects', ...
        'Style', 'text', ...
        'Tag', 'textObjects');
    ...
    popupObjects = uicontrol(...
        ...
        'Parent', guiSortomato, ...
        'Position', [84 116+extraSpace 100 24], ...
        'String', {'none'}, ...
        'Style', 'popupmenu', ...
        'Tag', 'popupObjects', ...
    ...
    uicontrol(...
        ...
        'Parent', guiSortomato, ...
        'Position', [190, 114+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushSurpassRefresh', ...
        'TooltipString', 'Refresh the Surpass objects list');
    
    %% Create add surpass from file
    
    % Button
    uicontrol(...
        'BackgroundColor', bColor, ...
        'Callback', {@loadobjectcallback, guiSortomato, popupObjects}, ...
        'FontSize', 12, ...
        'ForegroundColor', [0.5 0.5 0.5], ...
        'Parent', guiSortomato, ...
        'Position', [20 116 160 24], ...
        'String', 'Object from file', ...
        'Style', 'pushbutton', ...
        'ForegroundColor', fColor, ...
        'TooltipString', 'Load object from file');
    ...
    uicontrol(...
        ...
        'Position', [10, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [40, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushFlow', ...
    ...
    uicontrol(...
        ...
        'Position', [70, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [100, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushDistances', ...
    ...
    uicontrol(...
        ...
        'Position', [130, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [160, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushArrest', ...
    ...
    uicontrol(...
        ...
        'Position', [10, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [40, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [70, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushEdgeGrids', ...
    ...
    uicontrol(...
        ...
        'Position', [100, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [130, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [160, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
    ...
    uicontrol(...
        ...
        'Position', [220, 196+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushExportStats', ...
        'TooltipString', 'Export selected object statistics');
    
    uicontrol(...
        'BackgroundColor', bColor, ...
        'CData', sortomatoCData.BinaryStatMath, ...
        'Position', [220, 166+extraSpace, 24, 24], ...
        'String', '', ...
        'Style', 'pushbutton', ...
        'Tag', 'pushStatMath', ...
