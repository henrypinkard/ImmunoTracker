function sortomatograph(hObject, ~, statStruct, guiSortomato, varargin)
    ...
    uipushtool(toolbarGraph, ...
        ...
        'ClickedCallback', {@pushhighlightselectioncallback, xImarisApp, xObject, axesGraph, figSortomatoGraph}, ...
        'Tag', 'pushGraphDataExport', ...
        'TooltipString', 'Highlight selected Imaris objects')
    
    uipushtool(toolbarGraph, ...
        'ClickedCallback', {@pushhighlightselectionfromfilecallback, xObject, axesGraph, figSortomatoGraph}, ...
        'Tag', 'pushHighlightDataFromFile', ...
        'TooltipString', 'Highlight ImarisObjectsFromSelectionInFile')
