    ...
    methods
        ...
        function obj = sortomatopoly(varargin)
            ...
            if ~isequal(size(obj), [0 0])
                ...
                %Create a menu item to send in surface objects in selected
                %region
                uimenu(contextMenu, ...
                     'Callback', @(varargin)sendSurfacesInRgn(obj), ...
                    'Checked', 'off', ...
                    'Label', 'Send selected surfaces to surpass', ...
                    'Tag', 'menuSendSurfaces');
        ...
        function sendSurfacesInRgn(obj)
            ...
            inPlotIdxs = inpolygon(xData, yData, rgnVertices(:, 1), rgnVertices(:, 2));
            ...
            %delete surfaces currently in object
            xObject.RemoveAllSurfaces;
            
            func_addsurfacestosurpass([], surfFile, [], xObject, inIDs);        
        end
